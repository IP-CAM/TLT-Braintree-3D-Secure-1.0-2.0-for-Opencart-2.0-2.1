...
class ControllerPaymentTltBraintree3DS extends Controller {
	public function index() {
        ...
        if ($this->loadLibrary()) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/tltbraintree3DS.tpl')) {
				return $this->load->view($this->config->get('config_template') . '/template/payment/tltbraintree3DS.tpl', $data);
			} else {
				return $this->load->view('default/template/payment/tltbraintree3DS.tpl', $data);
			}
		}
        ...
        $this->load->model('payment/tltbraintree3DS');

        $locales = $this->model_payment_tltbraintree3DS->locales();
		...
		if ($data['threeDSecureVersion'] == '2' && !DROPIN) {
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/tltbraintree3DS20.tpl')) {
                return $this->load->view($this->config->get('config_template') . '/template/payment/tltbraintree3DS20.tpl', $data);
            } else {
                return $this->load->view('default/template/payment/tltbraintree3DS20.tpl', $data);
            }
        } else {
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/tltbraintree3DS.tpl')) {
                return $this->load->view($this->config->get('config_template') . '/template/payment/tltbraintree3DS.tpl', $data);
	...
	public function send() {
        ...
        try {
            ...
            if ($result->success) {
                ...
                $this->load->language('payment/tltbraintree3DS');
